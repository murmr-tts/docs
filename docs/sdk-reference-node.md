...
Official Node.js client for the murmr TTS API. Zero runtime dependencies, full TypeScript support.
...
> **ℹ️ Requirements**
> Node.js 18 or later. Uses native `fetch` and `AbortSignal.timeout()`.
...
Save, list, and delete voices programmatically. See the [Voice Management API](./voices.md) for full endpoint documentation.
...
```typescript
// Save a VoiceDesign output for reuse
